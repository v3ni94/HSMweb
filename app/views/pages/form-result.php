...
<?php if ($ok): ?>
<section class="section notice-ok" role="status">
...
<section class="section">
  ...
  <div class="notice" role="alert"><p><?= e(reset($errors)) ?></p><p>Telefon: <a href="tel:<?= e($company['phoneE164']) ?>"><?= e($company['phoneDisplay']) ?></a>, E-Mail: <a href="mailto:<?= e($company['email']) ?>"><?= e($company['email']) ?></a></p></div>
  <?php $errors = []; endif; ?>
