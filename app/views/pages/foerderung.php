  ...
  <table class="programs">
    ...
    <?php foreach ($programs as $p): ?>
      <tr>
        ...
        <td><?= e($p['fundingType']) ?></td>
        <td><span class="status <?= $statusClass($p['status']) ?>"><?= e($p['status']) ?></span><?php if ($p['calculationApproved']): ?><br><small>Automatische Berechnung freigegeben</small><?php else: ?><br><small>Nur Information, keine automatische Berechnung</small><?php endif; ?></td>
        <td>
          <ul class="compact">
        ...
        <td><?= e(fmt_date($p['checkedAt'])) ?><br><small>Nächste Prüfung: <?= e(fmt_date($p['reviewDueAt'])) ?></small></td>
      </tr>
    <?php endforeach; ?>
    </tbody>
  </table>
