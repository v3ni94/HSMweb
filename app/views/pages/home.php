...
<section class="hero-dark on-dark">
...
<section class="section finder on-dark" aria-labelledby="finder-h" data-projectfinder data-reveal>
  <div>
    ...
    <div class="finder-options" role="tablist" aria-label="Thema wählen">
      <button type="button" class="chip" role="tab" data-finder="heizung" aria-pressed="false" aria-selected="false"><?= $icon('heizung') ?> Heizung</button>
      <button type="button" class="chip" role="tab" data-finder="bad" aria-pressed="false" aria-selected="false"><?= $icon('bad') ?> Bad</button>
      <button type="button" class="chip" role="tab" data-finder="wasserschaden" aria-pressed="false" aria-selected="false"><?= $icon('wasser') ?> Wasserschaden</button>
      <button type="button" class="chip" role="tab" data-finder="sanierung" aria-pressed="false" aria-selected="false"><?= $icon('sanierung') ?> Sanierung</button>
    </div>
  </div>
  <div class="finder-panels">
    ...
    <div class="finder-result" role="tabpanel" data-finder-panel="heizung" hidden>
    ...
    <div class="finder-result" role="tabpanel" data-finder-panel="bad" hidden>
    ...
    <div class="finder-result" role="tabpanel" data-finder-panel="wasserschaden" hidden>
    ...
    <div class="finder-result" role="tabpanel" data-finder-panel="sanierung" hidden>
...
<section class="callout callout-dark on-dark" data-reveal>
...
<section class="section" aria-labelledby="fc-h">
  <ul class="card-grid" data-reveal>
    <li class="card card-dark"><div class="card-body"><span class="card-icon"><?= $icon('foerderung') ?></span><h3 id="fc-h">Fördercheck</h3><p>Heizungstausch, Bad und Barriereabbau, energetische Sanierung: In wenigen Schritten sehen Sie, welche Programme infrage kommen und was noch zu prüfen ist. Ohne Registrierung, alle Angaben bleiben im Browser.</p><a class="btn btn-secondary" href="/foerderrechner/">Förderung prüfen <?= $icon('arrow') ?></a></div></li>
